...
/**
 * Classe AdmsEditUserImage responsável por 
 *
 * @version 1.0
 *
...
class AdmsEditUserImage
{
    ...
    private function upload() {
        ...
        $this->diretorio = "app/adms/assets/images/users/" . $this->dados['id'] . "/";
    ...
    private function deleteImage() {
        if ((!empty($this->resultadoBd[0]['image']) OR ($this->resultadoBd[0]['image'] != null)) AND ($this->resultadoBd[0]['image'] != $this->nameImg)) {
            $this->delImg = "app/adms/assets/images/users/" . $this->dados['id'] . "/" . $this->resultadoBd[0]['image'];
