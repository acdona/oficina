    ...
    <div class="list-group-item">
        <div class="list-group-item">
            <div class="d-flex">
                ...
                <div class="p-2">
                    <a href="<?php echo URLADM; ?>add-city/index" class="btn btn-outline-success btn-sm">Cadastrar</a>
                </div>
            </div>
            <hr class="hr-title">
            <?php
                        ...
                        <tr class="table-striped">
                            ...
                            <td class="text-center">
                                <span class="d-none d-lg-block">
                                    <a href="<?php echo URLADM . 'view-city/index/' . $id; ?>" class="btn btn-outline-primary btn-sm">Visualizar</a>
                                ...
                                <div class="dropdown d-block d-lg-none">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                        <a class="dropdown-item" href="<?php echo URLADM . 'view-city/index/' . $id; ?>">Visualizar</a>
