...
<div class="content p-1">
    <div class="list-group-item">
        <div class="d-flex">
            ...
            <?php
            if (!empty($this->data['viewFormLevel'])) {
                extract($this->data['viewFormLevel'][0]);
                ?>
                <div class="p-2">
                    <span class="d-none d-lg-block">
                        <a href="<?php echo URLADM . 'edit-form-level/index'; ?>" class="btn btn-outline-warning btn-sm">Editar</a>
                    </span>
                    <div class="dropdown d-block d-lg-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                            <a class="dropdown-item" href="<?php echo URLADM . 'edit-form-level/index'; ?>">Editar</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
