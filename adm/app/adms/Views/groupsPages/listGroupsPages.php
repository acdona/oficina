    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 title">Listar Grupos de Páginas</h2>
            </div>
            <div class="p-2">
                <a href="<?php echo URLADM ?>add-groups-pages/index" class="btn btn-outline-success btn-sm">Cadastrar</a>
            </div>
        </div>
        <hr class="hr-title">
        <?php
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="d-none d-lg-block">
                                    <?php
                                        echo "<a href='" . URLADM . "order-groups-pages/index/$id?pag=" . $this->data['pag'] . "' class='btn btn-outline-secondary btn-sm'><i class='fas fa-angle-double-up'></i></a>";
                                    ?>
                                ...
                                <div class="dropdown d-block d-lg-none">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                        <?php
                                        echo "<a class='dropdown-item' href='" . URLADM . "order-groups-pages/index/$id?pag=" . $this->data['pag'] . "'>Ordem</a>";
                                        ?>
