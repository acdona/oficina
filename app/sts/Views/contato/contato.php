            ...
            <div class="col-md-6 mb-4">
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input name="email" type="email" class="form-control" id="email" placeholder="Seu melhor e-mail" value="<?php
                        if (isset($email)) {
                            echo $email;
                        }
                        ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" class="form-control" id="content" rows="3" placeholder="Conteúdo da mensagem" required><?php
                            if (isset($content)) {
                                echo $content;
                            }
                            ?></textarea>
